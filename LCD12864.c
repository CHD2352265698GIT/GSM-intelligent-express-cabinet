...
void Page_Theme(Page* Data)
{
	LCD12864_Write_Com(0x01);
	  ...
	  LCD12864_Display_Chars(4,1,"    杨文群     ");
	LCD12864_Write_Com(0x01);
		 if(Data->Key_Value)
	 {
		Data->PAGE_NUM = Access;
...
void Page_Select_Box(Page* Data)
{
	 ...
	 LCD12864_Display_Chars(2,1,"                ");
		...
		if(Data->Box[0])	 LCD12864_Display_Chars(3,1,"快递柜 1: 已存 ");
		           else 	 LCD12864_Display_Chars(3,1,"快递柜 1: 未存 "); 
		if(Data->Box[1])	 LCD12864_Display_Chars(4,1,"快递柜 2: 已存 ");
		           else 	 LCD12864_Display_Chars(4,1,"快递柜 2: 未存 ");
		Data->Error_Add=0;	 
